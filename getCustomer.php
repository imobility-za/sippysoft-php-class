...
try {
    ...
    try {
        $accountInfo = $client->getCustomerInfo(188); // Replace with actual customer ID
        echo "customer info: " . json_encode($accountInfo, JSON_PRETTY_PRINT) . "\n";
    } catch (Exception $e) {
        echo "Error getting customer info: " . $e->getMessage() . "\n";
    }
